...
const translations: Translation = {
  ...
  questionTextEn: {
    ...
    ar: "نص السؤال (الإنجليزية)",
  },
  questionTextAr: {
    en: "Question Text (Arabic)",
    ar: "نص السؤال (العربية)",
  },
  optionsEn: {
  ...
  questionAddedSuccess: {
    ...
    ar: "تمت إضافة السؤال بنجاح!",
  },
  questionUpdatedSuccess: {
  ...
  errorAddingQuestion: {
    en: "Error adding question.",
    ar: "حدث خطأ أثناء إضافة السؤال.",
  },
  errorUpdatingQuestion: {
    en: "Error updating question.",
    ar: "حدث خطأ أثناء تحديث السؤال.",
  },
  errorDeletingQuestion: {
    en: "Error deleting question.",
    ar: "حدث خطأ أثناء حذف السؤال.",
  },
  errorFetchingQuestions: {
    en: "Error fetching questions.",
    ar: "حدث خطأ أثناء جلب الأسئلة.",
  },
  errorSubmittingQuiz: {
    en: "Error submitting quiz.",
    ar: "حدث خطأ أثناء إرسال التقييم.",
  },
  loginRequired: {
    en: "Please log in to access this page.",
    ar: "الرجاء تسجيل الدخول للوصول إلى هذه الصفحة.",
  },
  quizCompleted: {
    en: "Quiz Completed!",
    ar: "اكتمل التقييم!",
  ...
  quizNotFound: {
    en: "Quiz attempt not found.",
    ar: "لم يتم العثور على محاولة التقييم.",
  },
  loading: {
    en: "Loading...",
    ar: "جار التحميل...",
...
export const getTranslation = (key: keyof Translation, lang: Language) => {
